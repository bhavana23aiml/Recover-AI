...
## Rule 46 — Simulation Must Be Explicit

Current Buildathon execution mode may be:

```text
SIMULATION
```

but must be clearly identified as such.
...
## Rule 83 — Current In-Memory Storage Must Be Labeled Temporary
...
No feature, AI capability, UI improvement, integration, or demo shortcut may weaken that sequence.
